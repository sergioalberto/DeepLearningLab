...
```
sudo vim.tiny ~/.bashrc
```

Move to the end of the file, and on the last line, add:

```
export PYTHONPATH=$PYTHONPATH:/home/pi/DeepLearningLab/ThievesRecognition/models/research:/home/pi/DeepLearningLab/ThievesRecognition/models/research/slim
```

## Thieves Detect
```
ssh -X pi@192.168.0.13
git clone https://github.com/sergioalberto/DeepLearningLab.git
cd /home/pi/DeepLearningLab/ThievesRecognition/models/research
protoc object_detection/protos/*.proto --python_out=.
cd object_detection
python3 thieves_detection_rpi.py
```
